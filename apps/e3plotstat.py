...
# Run 6
ax.add_patch(patches.Rectangle((dateRun6Start, yMin), dateRun6End-dateRun6Start, yMax, fill=1, facecolor="#c0392b", alpha=0.1, edgecolor="red", linestyle='dashed', linewidth=2))
