...
def make_webpage_index(monitorData,
    ...
    ### Generic message
    w.write('<h2 style="margin:0;"><i>[EEE Monitor info] RUN 3 ended on May 31, 2017</i></h2>')
    w.write('<h2 style="margin:0;"><i>[EEE Monitor info] RUN 4 will start in autumn</i></h2>')
