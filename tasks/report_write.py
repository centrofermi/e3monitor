...
def report_write(reportData,
    ...
    w.write(todayStr)
    w.write(' - RUN 5 (data taking): Giorno ')
    w.write(day_run())
    w.write('''
********************************************
...
********************************************
In questo momento, la situazione dei Telescopi EEE nelle scuole risulta la seguente:\n
''')
    ...
    ################################################
    w.write('Tutte le scuole sono invitate a compilare ogni giorno l\'e-logbook del Run 5\n')
    w.write('al seguente indirizzo: http://eee.centrofermi.it/elog/Run5\n\n')
...
E-logbook scuole: http://eee.centrofermi.it/elog/Run5
Archivio degli Shift Report Automatici inviati fino adesso:
http://eee.centrofermi.it/monitor/run5reports
