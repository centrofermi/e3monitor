...
const Float_t tmin = -5000; //ns
const Float_t tmax = 5000; //ns
...
Float_t doCoinc(const char *fileIn="coincLODI_0102n.root",TCanvas *cout = NULL,Float_t &rate,Float_t &rateErr){
