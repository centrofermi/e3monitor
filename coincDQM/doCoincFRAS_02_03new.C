...
Int_t maxWeathTimeDelay[2] = {36000000,36000000};
...
Float_t doCoinc(const char *fileIn="coincFRAS_0203n.root",TCanvas *cout = NULL,Float_t &rate,Float_t &rateErr){
